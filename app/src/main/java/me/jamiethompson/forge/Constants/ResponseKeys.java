 ...
 * API response and request key constants
 */
...
public class ResponseKeys {
    ...
    final public static String EMAIL_ID_KEY = "email_id";
    // Response Parameters
    ...
    final public static String MAIL_ID_KEY = "mail_id";
    final public static String SUBJECT_JSON_KEY = "mail_subject";
    final public static String EXCERPT_JSON_KEY = "mail_excerpt";
    final public static String BODY_JSON_KEY = "mail_body";
